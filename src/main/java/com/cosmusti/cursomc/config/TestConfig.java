package com.cosmusti.cursomc.config;
...
import com.cosmusti.cursomc.domain.Pagamento;
import com.cosmusti.cursomc.domain.PagamentoComBoleto;
import com.cosmusti.cursomc.domain.PagamentoComCartao;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Categoria cat9 = new Categoria(null, "Esportivo");

        Produto p1 = new Produto(null, "Computador", 2000.00);
        Produto p2 = new Produto(null, "Impressora", 800.00);
        Produto p3 = new Produto(null, "Mouse", 80.00);
        Produto p4 = new Produto(null, "Abajour", 100.00);
        Produto p5 = new Produto(null, "Mesa de Esctirório", 300.00);
        Produto p6 = new Produto(null, "Toalha", 50.00);
        Produto p7 = new Produto(null, "Colcha", 200.00);
        Produto p8 = new Produto(null, "TC True Color", 1200.00);
        ...
        cli1.getTelefones().addAll(Arrays.asList("327358574","558746523"));
        ...
        Pagamento pgto2 = new PagamentoComBoleto(null, sdf.parse("20/10/2017 00:00"),null, EstadoPagamento.PENDENTE, ped2);

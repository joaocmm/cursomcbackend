...
import com.cosmusti.cursomc.dto.ProdutoDTO;
import com.cosmusti.cursomc.resources.utils.URL;
import com.cosmusti.cursomc.services.ProdutoService;
...
public class ProdutoResource {
    ...
    public ResponseEntity<Page<ProdutoDTO>> findPage(
        ...
        Page<Produto> lista = service.buscar(nomeDecoded, ids,page,linesPerPage, orderBy, direction);
